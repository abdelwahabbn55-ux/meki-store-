const translations = {
    ar: {
        ...
        cat_hardware: "أقفال و مفاتيح",
        cat_home: "لوازم منزلية",
    ...
    fr: {
        ...
        hero_subtitle: "Qualité, confiance et professionnalisme à votre service. Découvrez notre large gamme d'outils.",
        hero_btn_shop: "Voir les produits",
        hero_btn_wa: "Commander via WhatsApp",
        categories_title: "Nos Catégories",
        cat_tools: "Outils",
        cat_cleaning: "Nettoyage",
        cat_hardware: "Quincaillerie",
        cat_home: "Maison",
        products_title: "Produits Vedettes",
        order_wa: "Commander sur WhatsApp",
        why_quality: "Haute Qualité",
        why_quality_desc: "Nous choisissons les meilleures marques mondiales et locales.",
        why_price: "Prix Abordables",
        why_price_desc: "Le meilleur rapport qualité-prix du marché.",
        why_delivery: "Livraison Rapide",
        why_delivery_desc: "Livraison à domicile en un temps record.",
        why_trust: "Service Fiable",
        why_trust_desc: "Nous sommes là pour vous aider à tout moment.",
        footer_desc: "Votre destination numéro un pour tout ce qui concerne la maison à Relizane.",
    ...
    en: {
        ...
        nav_contact: "Contact",
        hero_title: "Everything your home needs in one place",
        hero_subtitle: "Quality, trust, and professionalism at your service. Discover our wide range of tools.",
        hero_btn_shop: "Browse Products",
        hero_btn_wa: "Order via WhatsApp",
        categories_title: "Selected Categories",
        cat_tools: "Tools",
        cat_cleaning: "Cleaning",
        cat_hardware: "Locks & Hardware",
        cat_home: "Home Accessories",
        products_title: "Featured Products",
        order_wa: "Order on WhatsApp",
        why_quality: "High Quality",
        why_quality_desc: "We pick the best global and local brands.",
        why_price: "Fair Prices",
        why_price_desc: "Best value for money in the market.",
        why_delivery: "Fast Delivery",
        why_delivery_desc: "Home delivery in record time.",
        why_trust: "Reliable Service",
        why_trust_desc: "We are here to help you anytime.",
        footer_desc: "Your number one destination for home supplies in Relizane.",
...
function renderProducts() {
    ...
    // Re-trigger scroll reveal since new elements were added
    initReveal();
}
